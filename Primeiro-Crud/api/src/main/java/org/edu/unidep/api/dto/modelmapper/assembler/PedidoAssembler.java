...
public class PedidoAssembler {
	...
	public PedidoResponse toResponse(Pedido pedido, UriInfo uriInfo) {
		...
		pedidoResponse.addLink(apiLinks.linkToPedidosListarData(pedido.getDataEmissao().toString(), uriInfo));
		pedidoResponse.addLink(apiLinks.linkToPedidosListarNomeCliente(pedido.getCliente().getNome(), uriInfo));
		pedidoResponse.addLink(apiLinks.linkToPedidosListarNomeFuncionario(pedido.getFuncionario().getNome(), uriInfo));
		pedidoResponse.addLink(apiLinks.linkToPedidosListarComFiltro(uriInfo));
		pedidoResponse.addLink(apiLinks.linkToPedidosBuscar(pedido.getId(), uriInfo));
		pedidoResponse.addLink(apiLinks.linkToPedidosBuscarPorCodigo(pedido.getUuidCode(), uriInfo));
		pedidoResponse.addLink(apiLinks.linkToPedidoRegistrar(uriInfo));
